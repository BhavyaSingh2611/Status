...
public class StatusScreen extends StatusScreenBase {
    ...
    private static final ResourceLocation AFK = new ResourceLocation(Status.MODID, "textures/icons/afk.png");
    ...
    private static final ResourceLocation NO_MIC = new ResourceLocation(Status.MODID, "textures/icons/no_mic.png");


    public StatusScreen() {
        super(Component.translatable("gui.status.title"), 145, 230);
    }
    ...
    protected void init() {
        ...
        AvailabilityButton afk = new AvailabilityButton(x, y, width, height, Component.translatable("message.status.afk"), Availability.AFK);
        addRenderableWidget(afk);
        y += height + 1;
        ...
        StateButton noMic = new StateButton(x, y, width, height, Component.translatable("message.status.no_mic"), "no_mic");
        addRenderableWidget(noMic);
        y += height + 1;
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        renderIcon(guiGraphics, AFK, x, y + 2);
        y += height + 1;
        ...
        renderIcon(guiGraphics, NO_MIC, x, y + 2);
        y += height + 1;
